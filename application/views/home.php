      ...
      <div class="main">
        ...
        <header>
          ...
          <nav>
            <ul id="menu">
              ...
              <li><a href="http://localhost/abc/index.php/contact/index">Contact Us</a></li>
        ...
        <article id="content">
          <div class="slider_bg">
            <div class="slider">
              <ul class="items">
                <li> <img src="<?php echo base_url()?>templates/images/home1.jpg" alt="">
                ...
                <li> <img src="<?php echo base_url()?>templates/images/home2.jpg" alt="">
                  <!-- <div class="banner"> <strong>succulent<span>meat</span></strong> <b>Dish of the Day</b> -->
                    <!-- <p> <span>Lorem ipsum dolamet consectetur <br> -->
                      <!-- adipisicing elit, sed do eiusmod tempor aliqua enim ad minim veniam, quis nosinci- didunt ut labore et dolore.</span> </p> -->
                  <!-- </div> -->
                </li>
                <li> <img src="<?php echo base_url()?>templates/images/home3.jpg" alt="">
            ...
            <section class="cols pad_left1">
              <div class="box">
                <div>
                  ...
                  <p class="pad_bot1">We are truly delighted to offer great-tasting, super-nutritious juices, smoothies and foods –  We have fun with what we do and look forward to being of service to you in any capacity.  Have fun, be amazing!</p>
                  <!-- <a href="#" class="button1">Read More</a> </div> -->
              </div>
            </section>
            <section class="cols pad_left1">
